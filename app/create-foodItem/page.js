    ...
    >
      ...
      <div className="md:flex md:space-x-4">
        <div className="flex w-full  ">
          <label className="w-full flex space-x-4 justify-center items-center px-4 py-2 bg-red-50 text-red-950 rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-blue hover:text-white-red-800">
            <svg
              className="size-7"
              fill="currentColor"
              xmlns="http://www.w3.org/2000/svg"
